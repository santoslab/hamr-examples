...
object Manage_Regulator_Mode__InjectionProvider_Ext {
  ...
  def init(): Unit = {
    Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Injection_Service.register(
      new Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Injection_Provider {
        override def pre_receiveInput(): Unit = {
          // simulate the arrival of data on unconnected internal_failure incoming data port
          val internal_failure_id = isolette.Arch.isolette_single_sensor_Instance_thermostat_regulate_temperature_manage_regulator_mode.initialization_api.internal_failure_Id
