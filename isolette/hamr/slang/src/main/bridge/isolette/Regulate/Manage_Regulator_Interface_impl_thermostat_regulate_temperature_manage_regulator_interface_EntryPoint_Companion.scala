...
object Manage_Regulator_Interface_impl_thermostat_regulate_temperature_manage_regulator_interface_EntryPoint_Companion {
  ...
  def post_initialise(): Unit = {
    ...
    isolette.runtimemonitor.RuntimeMonitor.observePostState(Arch.isolette_single_sensor_Instance_thermostat_regulate_temperature_manage_regulator_interface.id, isolette.runtimemonitor.ObservationKind.manage_regulator_interface_postInit, postStateContainer_wL)
  }
  ...
  def pre_compute(): Unit = {
    ...
    // the rest can now be performed via a different thread
    isolette.runtimemonitor.RuntimeMonitor.observePreState(Arch.isolette_single_sensor_Instance_thermostat_regulate_temperature_manage_regulator_interface.id, isolette.runtimemonitor.ObservationKind.manage_regulator_interface_preCompute, preStateContainer_wL.asInstanceOf[Option[art.DataContent]])
  }
  ...
  def post_compute(): Unit = {
    ...
    // the rest can now be performed via a different thread
    isolette.runtimemonitor.RuntimeMonitor.observePrePostState(Arch.isolette_single_sensor_Instance_thermostat_regulate_temperature_manage_regulator_interface.id, isolette.runtimemonitor.ObservationKind.manage_regulator_interface_postCompute, preStateContainer_wL.asInstanceOf[Option[art.DataContent]], postStateContainer_wL)
  }
}