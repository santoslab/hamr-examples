...
object Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_GumboX {
  ...
  @strictpure def compute_CEP_T_Case (
      ...
      api_regulator_mode: Isolette_Data_Model.Regulator_Mode.Type,
      api_upper_desired_temp: Isolette_Data_Model.Temp_impl): B =
    compute_case_REQ_MHS_1(api_heat_control, api_regulator_mode) &
    compute_case_REQ_MHS_2(api_current_tempWstatus, api_heat_control, api_lower_desired_temp, api_regulator_mode) &
    compute_case_REQ_MHS_3(api_current_tempWstatus, api_heat_control, api_regulator_mode, api_upper_desired_temp) &
    compute_case_REQ_MHS_4(In_lastCmd, api_current_tempWstatus, api_heat_control, api_lower_desired_temp, api_regulator_mode, api_upper_desired_temp) &
    compute_case_REQ_MHS_5(api_heat_control, api_regulator_mode)
  ...
  @strictpure def compute_CEP_Post (
    ...
    (// CEP-Guar: guarantee clauses of manage_heat_source's compute entrypoint
     ...
     compute_CEP_T_Case (In_lastCmd, api_current_tempWstatus, api_heat_control, api_lower_desired_temp, api_regulator_mode, api_upper_desired_temp))
}
