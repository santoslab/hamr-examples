...
object Manage_Regulator_Interface_impl_thermostat_regulate_temperature_manage_regulator_interface_GumboX {
  ...
  /** CEP-T-Case: Top-Level case contracts for manage_regulator_interface's compute entrypoint
    *
    * @param api_current_tempWstatus port variable* @param api_displayed_temp port variable* @param api_interface_failure port variable* @param api_lower_desired_temp port variable* @param api_lower_desired_tempWstatus port variable* @param api_regulator_mode port variable* @param api_regulator_status port variable* @param api_upper_desired_temp port variable* @param api_upper_desired_tempWstatus port variable
    */
  @strictpure def compute_CEP_T_Case (
    ...
    compute_case_REQ_MRI_4(api_current_tempWstatus, api_displayed_temp, api_regulator_mode) &
    compute_case_REQ_MRI_5() &
    compute_case_REQ_MRI_6(api_interface_failure, api_upper_desired_tempWstatus) &
    compute_case_REQ_MRI_7(api_interface_failure, api_lower_desired_tempWstatus, api_upper_desired_tempWstatus) &
    compute_case_REQ_MRI_8(api_interface_failure, api_lower_desired_temp, api_lower_desired_tempWstatus, api_upper_desired_temp, api_upper_desired_tempWstatus) &
  ...
  @strictpure def compute_CEP_Post (
    ...
    (// CEP-T-Case: case clauses of manage_regulator_interface's compute entrypoint
     compute_CEP_T_Case (api_current_tempWstatus, api_displayed_temp, api_interface_failure, api_lower_desired_temp, api_lower_desired_tempWstatus, api_regulator_mode, api_regulator_status, api_upper_desired_temp, api_upper_desired_tempWstatus))
}
