...
object Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_EntryPoint_Companion {
  ...
  def post_initialise(): Unit = {
    ...
    isolette.runtimemonitor.RuntimeMonitor.observeInitialisePostState(Arch.isolette_single_sensor_Instance_temperature_sensor_cpi_thermostat.id, isolette.runtimemonitor.ObservationKind.thermostat_postInit, postStateContainer_wL)
  }
  ...
  def pre_compute(): Unit = {
    ...
    // the rest can now be performed via a different thread
    isolette.runtimemonitor.RuntimeMonitor.observeComputePreState(Arch.isolette_single_sensor_Instance_temperature_sensor_cpi_thermostat.id, isolette.runtimemonitor.ObservationKind.thermostat_preCompute, preStateContainer_wL.asInstanceOf[Option[art.DataContent]])
  }
  ...
  def post_compute(): Unit = {
    ...
    // the rest can now be performed via a different thread
    isolette.runtimemonitor.RuntimeMonitor.observeComputePrePostState(Arch.isolette_single_sensor_Instance_temperature_sensor_cpi_thermostat.id, isolette.runtimemonitor.ObservationKind.thermostat_postCompute, preStateContainer_wL.asInstanceOf[Option[art.DataContent]], postStateContainer_wL)
  }
}