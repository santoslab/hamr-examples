...
object Schedulers {
  ...
  val staticSchedule: DScheduleSpec = DScheduleSpec(0, 0, DSchedule(ISZ(
    ...
    Slot(Arch.isolette_single_sensor_Instance_thermostat_regulate_temperature_detect_regulator_failure.id, maxExecutionTime),
    ...
    Slot(Arch.isolette_single_sensor_Instance_thermostat_monitor_temperature_detect_monitor_failure.id, maxExecutionTime),
