...
object TranspilerUtil {
  def touch(): Unit = {
    if(F) {
      ...
      println(Schedulers.isolette_single_sensor_Instance_thermostat_regulate_temperature_detect_regulator_failure_timingProperties)
      ...
      println(Schedulers.isolette_single_sensor_Instance_thermostat_monitor_temperature_detect_monitor_failure_timingProperties)
