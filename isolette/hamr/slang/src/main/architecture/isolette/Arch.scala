...
object Arch {
  ...
  val isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface : isolette.Monitor.Manage_Monitor_Interface_impl_thermostat_monitor_temperature_manage_monitor_interface_Bridge = {
    val upper_alarm_tempWstatus = Port[Isolette_Data_Model.TempWstatus_impl] (id = portId"18", name = "isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_upper_alarm_tempWstatus", mode = DataIn)
    val lower_alarm_tempWstatus = Port[Isolette_Data_Model.TempWstatus_impl] (id = portId"19", name = "isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_lower_alarm_tempWstatus", mode = DataIn)
    val current_tempWstatus = Port[Isolette_Data_Model.TempWstatus_impl] (id = portId"20", name = "isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_current_tempWstatus", mode = DataIn)
    val monitor_mode = Port[Isolette_Data_Model.Monitor_Mode.Type] (id = portId"21", name = "isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_monitor_mode", mode = DataIn)
    val upper_alarm_temp = Port[Isolette_Data_Model.Temp_impl] (id = portId"22", name = "isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_upper_alarm_temp", mode = DataOut)
    val lower_alarm_temp = Port[Isolette_Data_Model.Temp_impl] (id = portId"23", name = "isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_lower_alarm_temp", mode = DataOut)
    val monitor_status = Port[Isolette_Data_Model.Status.Type] (id = portId"24", name = "isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_monitor_status", mode = DataOut)
    val interface_failure = Port[Isolette_Data_Model.Failure_Flag_impl] (id = portId"25", name = "isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_interface_failure", mode = DataOut)
  ...
  val isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_alarm : isolette.Monitor.Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Bridge = {
    val current_tempWstatus = Port[Isolette_Data_Model.TempWstatus_impl] (id = portId"26", name = "isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_alarm_current_tempWstatus", mode = DataIn)
    val lower_alarm_temp = Port[Isolette_Data_Model.Temp_impl] (id = portId"27", name = "isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_alarm_lower_alarm_temp", mode = DataIn)
    val upper_alarm_temp = Port[Isolette_Data_Model.Temp_impl] (id = portId"28", name = "isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_alarm_upper_alarm_temp", mode = DataIn)
    val monitor_mode = Port[Isolette_Data_Model.Monitor_Mode.Type] (id = portId"29", name = "isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_alarm_monitor_mode", mode = DataIn)
    val alarm_control = Port[Isolette_Data_Model.On_Off.Type] (id = portId"30", name = "isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_alarm_alarm_control", mode = DataOut)
  ...
  val isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode : isolette.Monitor.Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_Bridge = {
    val current_tempWstatus = Port[Isolette_Data_Model.TempWstatus_impl] (id = portId"31", name = "isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_current_tempWstatus", mode = DataIn)
    val interface_failure = Port[Isolette_Data_Model.Failure_Flag_impl] (id = portId"32", name = "isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_interface_failure", mode = DataIn)
    val internal_failure = Port[Isolette_Data_Model.Failure_Flag_impl] (id = portId"33", name = "isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_internal_failure", mode = DataIn)
    val monitor_mode = Port[Isolette_Data_Model.Monitor_Mode.Type] (id = portId"34", name = "isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_monitor_mode", mode = DataOut)
  ...
  val isolette_single_sensor_Instance_thermostat_monitor_temperature_detect_monitor_failure : isolette.Monitor.Detect_Monitor_Failure_impl_thermostat_monitor_temperature_detect_monitor_failure_Bridge = {
    val internal_failure = Port[Isolette_Data_Model.Failure_Flag_impl] (id = portId"35", name = "isolette_single_sensor_Instance_thermostat_monitor_temperature_detect_monitor_failure_internal_failure", mode = DataOut)
  ...
  val isolette_single_sensor_Instance_operator_interface_oip_oit : isolette.Isolette.operator_interface_thread_impl_operator_interface_oip_oit_Bridge = {
    val regulator_status = Port[Isolette_Data_Model.Status.Type] (id = portId"36", name = "isolette_single_sensor_Instance_operator_interface_oip_oit_regulator_status", mode = DataIn)
    val monitor_status = Port[Isolette_Data_Model.Status.Type] (id = portId"37", name = "isolette_single_sensor_Instance_operator_interface_oip_oit_monitor_status", mode = DataIn)
    val display_temperature = Port[Isolette_Data_Model.Temp_impl] (id = portId"38", name = "isolette_single_sensor_Instance_operator_interface_oip_oit_display_temperature", mode = DataIn)
    val alarm_control = Port[Isolette_Data_Model.On_Off.Type] (id = portId"39", name = "isolette_single_sensor_Instance_operator_interface_oip_oit_alarm_control", mode = DataIn)
    val lower_desired_tempWstatus = Port[Isolette_Data_Model.TempWstatus_impl] (id = portId"40", name = "isolette_single_sensor_Instance_operator_interface_oip_oit_lower_desired_tempWstatus", mode = DataOut)
    val upper_desired_tempWstatus = Port[Isolette_Data_Model.TempWstatus_impl] (id = portId"41", name = "isolette_single_sensor_Instance_operator_interface_oip_oit_upper_desired_tempWstatus", mode = DataOut)
    val lower_alarm_tempWstatus = Port[Isolette_Data_Model.TempWstatus_impl] (id = portId"42", name = "isolette_single_sensor_Instance_operator_interface_oip_oit_lower_alarm_tempWstatus", mode = DataOut)
    val upper_alarm_tempWstatus = Port[Isolette_Data_Model.TempWstatus_impl] (id = portId"43", name = "isolette_single_sensor_Instance_operator_interface_oip_oit_upper_alarm_tempWstatus", mode = DataOut)
  ...
  val isolette_single_sensor_Instance_temperature_sensor_cpi_thermostat : isolette.Devices.Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_Bridge = {
    val air = Port[Isolette_Data_Model.PhysicalTemp_impl] (id = portId"44", name = "isolette_single_sensor_Instance_temperature_sensor_cpi_thermostat_air", mode = DataIn)
    val current_tempWstatus = Port[Isolette_Data_Model.TempWstatus_impl] (id = portId"45", name = "isolette_single_sensor_Instance_temperature_sensor_cpi_thermostat_current_tempWstatus", mode = DataOut)
  ...
  val isolette_single_sensor_Instance_heat_source_cpi_heat_controller : isolette.Devices.Heat_Source_impl_heat_source_cpi_heat_controller_Bridge = {
    val heat_control = Port[Isolette_Data_Model.On_Off.Type] (id = portId"46", name = "isolette_single_sensor_Instance_heat_source_cpi_heat_controller_heat_control", mode = DataIn)
    val heat_out = Port[Isolette_Environment.Heat.Type] (id = portId"47", name = "isolette_single_sensor_Instance_heat_source_cpi_heat_controller_heat_out", mode = DataOut)
