...
object Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_App extends App {
  ...
  def initialiseArchitecture(seed: Z): Unit = {
    ...
    PlatformComm.initialise(seed, lower_desired_tempPortIdOpt)
    PlatformComm.initialise(seed, upper_desired_tempPortIdOpt)
  ...
  def compute(): Unit = {
    ...
    {
      val out = IPCPorts.emptyReceiveAsyncOut
      PlatformComm.receiveAsync(lower_desired_tempPortIdOpt, out)
      out.value2 match {
    ...
    {
      val out = IPCPorts.emptyReceiveAsyncOut
      PlatformComm.receiveAsync(upper_desired_tempPortIdOpt, out)
      out.value2 match {
