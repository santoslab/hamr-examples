...
@msig trait Detect_Monitor_Failure_impl_thermostat_monitor_temperature_detect_monitor_failure_TestApi {
  ...
  def get_internal_failure_payload(): Option[Isolette_Data_Model.Failure_Flag_impl_Payload] = {
    return ArtNative.observeOutInfrastructurePort(Arch.isolette_single_sensor_Instance_thermostat_monitor_temperature_detect_monitor_failure.initialization_api.internal_failure_Id).asInstanceOf[Option[Isolette_Data_Model.Failure_Flag_impl_Payload]]
  }
