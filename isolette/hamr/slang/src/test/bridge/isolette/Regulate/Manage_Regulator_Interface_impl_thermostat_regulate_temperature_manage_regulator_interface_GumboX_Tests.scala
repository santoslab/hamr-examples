...
class Manage_Regulator_Interface_impl_thermostat_regulate_temperature_manage_regulator_interface_GumboX_Tests extends Manage_Regulator_Interface_impl_thermostat_regulate_temperature_manage_regulator_interface_GumboX_TestHarness {

  {
    ...
    val ranLiblower_desired_tempWstatus = new RandomLib(new Random.Gen64Impl(Xoshiro256.create))
    val ranLibregulator_mode = new RandomLib(new Random.Gen64Impl(Xoshiro256.create))
    val ranLibupper_desired_tempWstatus = new RandomLib(new Random.Gen64Impl(Xoshiro256.create))
