...
B isolette_Regulate_Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_GumboX_compute_CEP_Post(STACK_FRAME isolette_Isolette_Data_Model_On_Off_Type In_lastCmd, isolette_Isolette_Data_Model_On_Off_Type lastCmd, isolette_Isolette_Data_Model_TempWstatus_impl api_current_tempWstatus, isolette_Isolette_Data_Model_Temp_impl api_lower_desired_temp, isolette_Isolette_Data_Model_Regulator_Mode_Type api_regulator_mode, isolette_Isolette_Data_Model_Temp_impl api_upper_desired_temp, isolette_Isolette_Data_Model_On_Off_Type api_heat_control) {
  ...
  B _r_;
  {
    ...
    B t_1 = isolette_Regulate_Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_GumboX_compute_CEP_T_Case(SF In_lastCmd, (isolette_Isolette_Data_Model_TempWstatus_impl) api_current_tempWstatus, (isolette_Isolette_Data_Model_Temp_impl) api_lower_desired_temp, api_regulator_mode, (isolette_Isolette_Data_Model_Temp_impl) api_upper_desired_temp, api_heat_control);
    _r_ = B__and(t_0, t_1);
  }
  return _r_;
}
...
B isolette_Regulate_Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_GumboX_compute_CEP_T_Case(STACK_FRAME isolette_Isolette_Data_Model_On_Off_Type In_lastCmd, isolette_Isolette_Data_Model_TempWstatus_impl api_current_tempWstatus, isolette_Isolette_Data_Model_Temp_impl api_lower_desired_temp, isolette_Isolette_Data_Model_Regulator_Mode_Type api_regulator_mode, isolette_Isolette_Data_Model_Temp_impl api_upper_desired_temp, isolette_Isolette_Data_Model_On_Off_Type api_heat_control) {
  ...
  B _r_;
  {
    ...
    B t_1 = isolette_Regulate_Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_GumboX_compute_case_REQ_MHS_2(SF (isolette_Isolette_Data_Model_TempWstatus_impl) api_current_tempWstatus, (isolette_Isolette_Data_Model_Temp_impl) api_lower_desired_temp, api_regulator_mode, api_heat_control);
    B t_2 = isolette_Regulate_Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_GumboX_compute_case_REQ_MHS_3(SF (isolette_Isolette_Data_Model_TempWstatus_impl) api_current_tempWstatus, api_regulator_mode, (isolette_Isolette_Data_Model_Temp_impl) api_upper_desired_temp, api_heat_control);
    ...
    B t_4 = isolette_Regulate_Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_GumboX_compute_case_REQ_MHS_5(SF api_regulator_mode, api_heat_control);
