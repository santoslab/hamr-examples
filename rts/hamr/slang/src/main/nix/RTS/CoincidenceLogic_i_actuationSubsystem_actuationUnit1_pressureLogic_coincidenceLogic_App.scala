...
object CoincidenceLogic_i_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic_App extends App {

  val entryPoints: Bridge.EntryPoints = Arch.RTS_i_Instance_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic.entryPoints
  val appPortId: Art.PortId = IPCPorts.CoincidenceLogic_i_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic_App
  val appPortIdOpt: Option[Art.PortId] = Some(appPortId)

  // incoming ports
  val channel1PortId: Art.PortId = Arch.RTS_i_Instance_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic.channel1.id
  val channel1PortIdOpt: Option[Art.PortId] = Some(channel1PortId)
  val channel2PortId: Art.PortId = Arch.RTS_i_Instance_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic.channel2.id
  val channel2PortIdOpt: Option[Art.PortId] = Some(channel2PortId)
  val channel3PortId: Art.PortId = Arch.RTS_i_Instance_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic.channel3.id
  val channel3PortIdOpt: Option[Art.PortId] = Some(channel3PortId)
  val channel4PortId: Art.PortId = Arch.RTS_i_Instance_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic.channel4.id
  ...
  def main(args: ISZ[String]): Z = {
    ...
    println("CoincidenceLogic_i_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic_App starting ...")
