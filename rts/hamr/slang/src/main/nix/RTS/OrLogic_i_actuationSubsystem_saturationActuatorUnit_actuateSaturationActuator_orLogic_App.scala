...
object OrLogic_i_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_App extends App {

  val entryPoints: Bridge.EntryPoints = Arch.RTS_i_Instance_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic.entryPoints
  val appPortId: Art.PortId = IPCPorts.OrLogic_i_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_App
  val appPortIdOpt: Option[Art.PortId] = Some(appPortId)

  // incoming ports
  val channel1PortId: Art.PortId = Arch.RTS_i_Instance_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic.channel1.id
  val channel1PortIdOpt: Option[Art.PortId] = Some(channel1PortId)
  val channel2PortId: Art.PortId = Arch.RTS_i_Instance_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic.channel2.id
  ...
  def main(args: ISZ[String]): Z = {
    ...
    println("OrLogic_i_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_App starting ...")
