...
object Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_App extends App {

  val entryPoints: Bridge.EntryPoints = Arch.RTS_i_Instance_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator.entryPoints
  val appPortId: Art.PortId = IPCPorts.Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_App
  val appPortIdOpt: Option[Art.PortId] = Some(appPortId)

  // incoming ports
  val inputPortId: Art.PortId = Arch.RTS_i_Instance_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator.input.id
  val inputPortIdOpt: Option[Art.PortId] = Some(inputPortId)
  val manualActuatorInputPortId: Art.PortId = Arch.RTS_i_Instance_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator.manualActuatorInput.id
  ...
  def main(args: ISZ[String]): Z = {
    ...
    println("Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_App starting ...")
