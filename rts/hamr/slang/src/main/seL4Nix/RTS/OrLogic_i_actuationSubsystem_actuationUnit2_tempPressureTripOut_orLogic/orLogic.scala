...
package RTS.OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic
...
import RTS._
import RTS.Actuation.OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_seL4Nix

object orLogic extends App {

  val orLogicBridge : RTS.Actuation.OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_Bridge = {
    val channel1 = Port[Base_Types.Boolean] (id = portId"0", name = "RTS_i_Instance_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_channel1", mode = DataIn)
    val channel2 = Port[Base_Types.Boolean] (id = portId"1", name = "RTS_i_Instance_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_channel2", mode = DataIn)
    val actuate = Port[Base_Types.Boolean] (id = portId"2", name = "RTS_i_Instance_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_actuate", mode = DataOut)
  ...
  def receiveInput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    channel1_port = OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_seL4Nix.channel1_Receive()

    channel2_port = OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_seL4Nix.channel2_Receive()
  }
  ...
  def sendOutput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    if(actuate_port.nonEmpty) {
      OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_seL4Nix.actuate_Send(actuate_port.get)
      actuate_port = noData
    }
  }
