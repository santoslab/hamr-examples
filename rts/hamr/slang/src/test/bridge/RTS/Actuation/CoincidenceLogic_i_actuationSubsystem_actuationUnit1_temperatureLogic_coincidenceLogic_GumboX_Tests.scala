...
class CoincidenceLogic_i_actuationSubsystem_actuationUnit1_temperatureLogic_coincidenceLogic_GumboX_Tests extends CoincidenceLogic_i_actuationSubsystem_actuationUnit1_temperatureLogic_coincidenceLogic_GumboX_TestHarness_ScalaTest {
...

  {
    ...
    // getInputs - needed
    def getInputs(): Option[CoincidenceLogic_i_actuationSubsystem_actuationUnit1_temperatureLogic_coincidenceLogic_SlangCheckContainer] = {
      try {
        ...
        return Some(CoincidenceLogic_i_actuationSubsystem_actuationUnit1_temperatureLogic_coincidenceLogic_SlangCheckContainer(api_channel1,api_channel2,api_channel3,api_channel4))
      } catch {
