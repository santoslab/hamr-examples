...
class CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_GumboX_Tests extends CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_GumboX_TestHarness_ScalaTest {
  ...
  def getTestVector(): Option[CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_DSC_TestVector] = {
    try {
      ...
      return Some(CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_DSC_TestVector(api_channel1,api_channel2,api_channel3,api_channel4))
    } catch {
