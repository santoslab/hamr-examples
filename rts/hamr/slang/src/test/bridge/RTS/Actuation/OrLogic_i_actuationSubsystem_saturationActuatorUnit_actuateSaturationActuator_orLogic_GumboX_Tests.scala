...
class OrLogic_i_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_GumboX_Tests extends OrLogic_i_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_GumboX_TestHarness_ScalaTest {
  ...
  def getTestVector(): Option[OrLogic_i_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_DSC_TestVector] = {
    try {
      val api_channel1 = ranLibchannel1.nextB()
      val api_channel2 = ranLibchannel2.nextB()

      return Some(OrLogic_i_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_DSC_TestVector(api_channel1,api_channel2))
    } catch {
