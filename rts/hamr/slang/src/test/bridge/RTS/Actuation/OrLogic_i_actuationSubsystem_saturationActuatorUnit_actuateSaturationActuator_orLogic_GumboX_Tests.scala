...
class OrLogic_i_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_GumboX_Tests extends OrLogic_i_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_GumboX_TestHarness_ScalaTest {
...

  {
    ...
    // getInputs - needed
    def getInputs(): Option[OrLogic_i_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_SlangCheckContainer] = {
      try {
        val api_channel1 = ranLibchannel1.next_B()
        val api_channel2 = ranLibchannel2.next_B()

        return Some(OrLogic_i_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_SlangCheckContainer(api_channel1,api_channel2))
      } catch {
