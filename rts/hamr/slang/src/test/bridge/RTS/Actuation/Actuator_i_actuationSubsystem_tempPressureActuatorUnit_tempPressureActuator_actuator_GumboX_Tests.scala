...
class Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_GumboX_Tests extends Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_GumboX_TestHarness_ScalaTest {
...

  {
    ...
    // getInputs - needed
    def getInputs(): Option[Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_SlangCheckContainer] = {
      try {
        val api_input = ranLibinput.next_B()
        val api_manualActuatorInput = ranLibmanualActuatorInput.next_B()

        return Some(Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_SlangCheckContainer(api_input,api_manualActuatorInput))
      } catch {
