...
class Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_GumboX_Tests extends Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_GumboX_TestHarness_ScalaTest {
  ...
  def getTestVector(): Option[Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_DSC_TestVector] = {
    try {
      val api_input = ranLibinput.nextB()
      val api_manualActuatorInput = ranLibmanualActuatorInput.nextB()

      return Some(Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_DSC_TestVector(api_input,api_manualActuatorInput))
    } catch {
