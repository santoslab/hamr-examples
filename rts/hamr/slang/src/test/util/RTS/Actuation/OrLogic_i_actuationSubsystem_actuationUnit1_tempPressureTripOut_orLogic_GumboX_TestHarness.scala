...
@msig trait OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_GumboX_TestHarness extends OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_TestApi {
  def testComputeCB(
    ...
    val postResult = RTS.Actuation.OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_GumboX.compute_CEP_Post(api_channel1, api_channel2, api_actuate)
    if (!postResult) {
