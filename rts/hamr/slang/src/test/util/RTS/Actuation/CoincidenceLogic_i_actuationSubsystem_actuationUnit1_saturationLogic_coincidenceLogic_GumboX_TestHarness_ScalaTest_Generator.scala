            ...
            case Some(o) =>
              ...
              if (verbose) {
                ...
                println(st"""Replay Unit Test:
                            ...
                            |    val json = st${tq}${RTS.JSON.fromActuationCoincidenceLogic_i_actuationSubsystem_actuationUnit1_saturationLogic_coincidenceLogic_PreState_Container_P(o, T)}${tq}.render
