...
val InstrumentationMockThread_i_instrumentationMock_instrumentationMockThread: ISZ[String] = ISZ(
  ...
  //"--sequence-size", "24",  
  //"--sequence", s"MS[Z,Option[art.Bridge]]=1;IS[Z,art.UPort]=24",
  "--sequence-size", "1",
  "--sequence", s"MS[Z,Option[art.Bridge]]=1;IS[Z,art.UPort]=24;IS[Z,Z]=24;ISZ[((B,B,B,B,B,B,B,B,B,B,B,B),(B,B,B,B,B,B,B,B,B,B,B,B))]=9",

  "--constants", s"art.Art.maxComponents=1;art.Art.maxPorts=24",
...
val EventControlMockThread_i_eventControlMock_eventControlMockThread: ISZ[String] = ISZ(
  ...
  "--sequence", s"MS[Z,Option[art.Bridge]]=1;IS[Z,art.UPort]=2;IS[Z,(B,B)]=9",
...
val OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic: ISZ[String] = ISZ(
  ...
  "--string-size", "256",
  "--sequence-size", "3",
  "--sequence", s"MS[Z,Option[art.Bridge]]=1;IS[Z,art.UPort]=3",
