...
object TempSensorPeriodic_p_tcproc_tempSensor_GumboX_TestHarness_ScalaTest_Generator {
  ...
  def serializeReport(dir: Os.Path): Unit = {
    val filename = dir / s"TempSensorPeriodic_p_tcproc_tempSensor_GumboX_TestHarness_ScalaTest_Generator_${System.currentTimeMillis()}.json"
...
import TempSensorPeriodic_p_tcproc_tempSensor_GumboX_TestHarness_ScalaTest_Generator._
...
trait TempSensorPeriodic_p_tcproc_tempSensor_GumboX_TestHarness_ScalaTest_Generator extends TempSensorPeriodic_p_tcproc_tempSensor_GumboX_TestHarness_ScalaTest
  ...
  def getInitialiseProfiles: MSZ[TempSensorPeriodic_p_tcproc_tempSensor_Profile]

  def getDefaultInitialiseProfile: TempSensorPeriodic_p_tcproc_tempSensor_Profile = {
    return TempSensorPeriodic_p_tcproc_tempSensor_Profile (
      name = "Default Initialise Profile",
      numTests = 100)
  }

  def getProfiles_P: MSZ[TempSensorPeriodic_p_tcproc_tempSensor_Profile_P]
  ...
  def testInitialiseCB_Profile(profile: TempSensorPeriodic_p_tcproc_tempSensor_Profile): Unit = {
        ...
        while (j < profile.numTestVectorGenRetries && retry) {
          next(profile) match {
            case Some(o) =>
              ...
              val json = tc.JSON.fromTempSensorTempSensorPeriodic_p_tcproc_tempSensor_PreState_Container_P(o, T)
