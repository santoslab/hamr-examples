...
object OperatorInterfacePeriodic_p_tcproc_operatorInterface_GumboX_TestHarness_ScalaTest_Generator {
  ...
  def serializeReport(dir: Os.Path): Unit = {
    val filename = dir / s"OperatorInterfacePeriodic_p_tcproc_operatorInterface_GumboX_TestHarness_ScalaTest_Generator_${System.currentTimeMillis()}.json"
...
import OperatorInterfacePeriodic_p_tcproc_operatorInterface_GumboX_TestHarness_ScalaTest_Generator._

trait OperatorInterfacePeriodic_p_tcproc_operatorInterface_GumboX_TestHarness_ScalaTest_Generator extends OperatorInterfacePeriodic_p_tcproc_operatorInterface_GumboX_TestHarness_ScalaTest
  ...
  def getInitialiseProfiles: MSZ[OperatorInterfacePeriodic_p_tcproc_operatorInterface_Profile]

  def getDefaultInitialiseProfile: OperatorInterfacePeriodic_p_tcproc_operatorInterface_Profile = {
    return OperatorInterfacePeriodic_p_tcproc_operatorInterface_Profile (
      name = "Default Initialise Profile",
      numTests = 100)
  }

  def getProfiles_P: MSZ[OperatorInterfacePeriodic_p_tcproc_operatorInterface_Profile_P]

  def getDefaultProfile_P: OperatorInterfacePeriodic_p_tcproc_operatorInterface_Profile_P = {
    return OperatorInterfacePeriodic_p_tcproc_operatorInterface_Profile_P (
  ...
  def next(profile: OperatorInterfacePeriodic_p_tcproc_operatorInterface_Profile_P): Option[OperatorInterfacePeriodic_p_tcproc_operatorInterface_PreState_Container_P] = {
    try {
  ...
  def testInitialiseCB_Profile(profile: OperatorInterfacePeriodic_p_tcproc_operatorInterface_Profile): Unit = {
  ...
  def testComputeCB_Profile_P(profile: OperatorInterfacePeriodic_p_tcproc_operatorInterface_Profile_P): Unit = {
    for (i <- 0 until profile.numTests) {
        ...
        while (j < profile.numTestVectorGenRetries && retry) {
          next(profile) match {
            case Some(o) =>
              ...
              val json = tc.JSON.fromTempControlSoftwareSystemOperatorInterfacePeriodic_p_tcproc_operatorInterface_PreState_Container_P(o, T)
