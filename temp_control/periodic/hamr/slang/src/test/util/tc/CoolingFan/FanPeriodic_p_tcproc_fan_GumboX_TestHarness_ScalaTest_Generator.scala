...
object FanPeriodic_p_tcproc_fan_GumboX_TestHarness_ScalaTest_Generator {
  ...
  def serializeReport(dir: Os.Path): Unit = {
    val filename = dir / s"FanPeriodic_p_tcproc_fan_GumboX_TestHarness_ScalaTest_Generator_${System.currentTimeMillis()}.json"
...
import FanPeriodic_p_tcproc_fan_GumboX_TestHarness_ScalaTest_Generator._
...
trait FanPeriodic_p_tcproc_fan_GumboX_TestHarness_ScalaTest_Generator extends FanPeriodic_p_tcproc_fan_GumboX_TestHarness_ScalaTest
  ...
  def getProfiles_P: MSZ[FanPeriodic_p_tcproc_fan_Profile_P]
        ...
        while (j < profile.numTestVectorGenRetries && retry) {
          next(profile) match {
            case Some(o) =>
              ...
              val json = tc.JSON.fromCoolingFanFanPeriodic_p_tcproc_fan_PreState_Container_P(o, T)
