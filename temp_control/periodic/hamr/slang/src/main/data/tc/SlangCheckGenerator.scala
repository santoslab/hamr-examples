...
@record class Gen_CoolingFanFanPeriodic_p_tcproc_fan_PreState_wLContainer(param: RandomLibI) extends MJen[CoolingFan.FanPeriodic_p_tcproc_fan_PreState_wLContainer] {
  override def generate(f: CoolingFan.FanPeriodic_p_tcproc_fan_PreState_wLContainer => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextCoolingFanFanPeriodic_p_tcproc_fan_PreState_wLContainer())
...
@record class Gen_CoolingFanFanPeriodic_p_tcproc_fan_PostState_wLContainer(param: RandomLibI) extends MJen[CoolingFan.FanPeriodic_p_tcproc_fan_PostState_wLContainer] {
  override def generate(f: CoolingFan.FanPeriodic_p_tcproc_fan_PostState_wLContainer => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextCoolingFanFanPeriodic_p_tcproc_fan_PostState_wLContainer())
...
@record class Gen_TempControlSoftwareSystemOperatorInterfacePeriodic_p_tcproc_operatorInterface_PreState_wLContainer(param: RandomLibI) extends MJen[TempControlSoftwareSystem.OperatorInterfacePeriodic_p_tcproc_operatorInterface_PreState_wLContainer] {
  override def generate(f: TempControlSoftwareSystem.OperatorInterfacePeriodic_p_tcproc_operatorInterface_PreState_wLContainer => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlSoftwareSystemOperatorInterfacePeriodic_p_tcproc_operatorInterface_PreState_wLContainer())
...
@record class Gen_TempControlSoftwareSystemOperatorInterfacePeriodic_p_tcproc_operatorInterface_PostState_wLContainer(param: RandomLibI) extends MJen[TempControlSoftwareSystem.OperatorInterfacePeriodic_p_tcproc_operatorInterface_PostState_wLContainer] {
  override def generate(f: TempControlSoftwareSystem.OperatorInterfacePeriodic_p_tcproc_operatorInterface_PostState_wLContainer => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlSoftwareSystemOperatorInterfacePeriodic_p_tcproc_operatorInterface_PostState_wLContainer())
...
@record class Gen_TempControlSoftwareSystemTempControlPeriodic_p_tcproc_tempControl_PreState_wLContainer(param: RandomLibI) extends MJen[TempControlSoftwareSystem.TempControlPeriodic_p_tcproc_tempControl_PreState_wLContainer] {
  override def generate(f: TempControlSoftwareSystem.TempControlPeriodic_p_tcproc_tempControl_PreState_wLContainer => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlSoftwareSystemTempControlPeriodic_p_tcproc_tempControl_PreState_wLContainer())
...
@record class Gen_TempControlSoftwareSystemTempControlPeriodic_p_tcproc_tempControl_PostState_wLContainer(param: RandomLibI) extends MJen[TempControlSoftwareSystem.TempControlPeriodic_p_tcproc_tempControl_PostState_wLContainer] {
  override def generate(f: TempControlSoftwareSystem.TempControlPeriodic_p_tcproc_tempControl_PostState_wLContainer => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlSoftwareSystemTempControlPeriodic_p_tcproc_tempControl_PostState_wLContainer())
...
@record class Gen_TempSensorTempSensorPeriodic_p_tcproc_tempSensor_PreState_wLContainer(param: RandomLibI) extends MJen[TempSensor.TempSensorPeriodic_p_tcproc_tempSensor_PreState_wLContainer] {
  override def generate(f: TempSensor.TempSensorPeriodic_p_tcproc_tempSensor_PreState_wLContainer => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempSensorTempSensorPeriodic_p_tcproc_tempSensor_PreState_wLContainer())
...
@record class Gen_TempSensorTempSensorPeriodic_p_tcproc_tempSensor_PostState_wLContainer(param: RandomLibI) extends MJen[TempSensor.TempSensorPeriodic_p_tcproc_tempSensor_PostState_wLContainer] {
  override def generate(f: TempSensor.TempSensorPeriodic_p_tcproc_tempSensor_PostState_wLContainer => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempSensorTempSensorPeriodic_p_tcproc_tempSensor_PostState_wLContainer())
