...
object OperatorInterface_s_tcproc_operatorInterface_GumboX_TestHarness_ScalaTest_Generator {
  ...
  def serializeReport(dir: Os.Path): Unit = {
    val filename = dir / s"OperatorInterface_s_tcproc_operatorInterface_GumboX_TestHarness_ScalaTest_Generator_${System.currentTimeMillis()}.json"
...
import OperatorInterface_s_tcproc_operatorInterface_GumboX_TestHarness_ScalaTest_Generator._
...
trait OperatorInterface_s_tcproc_operatorInterface_GumboX_TestHarness_ScalaTest_Generator extends OperatorInterface_s_tcproc_operatorInterface_GumboX_TestHarness_ScalaTest
  ...
  def getInitialiseProfiles: MSZ[OperatorInterface_s_tcproc_operatorInterface_Profile]

  def getDefaultInitialiseProfile: OperatorInterface_s_tcproc_operatorInterface_Profile = {
    return OperatorInterface_s_tcproc_operatorInterface_Profile (
      name = "Default Initialise Profile",
      numTests = 100)
  }

  def getProfiles_P: MSZ[OperatorInterface_s_tcproc_operatorInterface_Profile_P]
  ...
  def testInitialiseCB_Profile(profile: OperatorInterface_s_tcproc_operatorInterface_Profile): Unit = {
        ...
        while (j < profile.numTestVectorGenRetries && retry) {
          next(profile) match {
            case Some(o) =>
              ...
              val json = tc.JSON.fromTempControlSoftwareSystemOperatorInterface_s_tcproc_operatorInterface_PreState_Container_P(o, T)
