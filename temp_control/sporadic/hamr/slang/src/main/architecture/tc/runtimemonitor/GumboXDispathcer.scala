...
object GumboXDispatcher {
  def dispatch(captureKind: CaptureKind.Type, preContainer: Option[art.DataContent], postContainer: Option[art.DataContent]): B = {
    captureKind match {
      case tc.runtimemonitor.CaptureKind.tempSensor_postInit =>
        ...
        return result
      case tc.runtimemonitor.CaptureKind.tempSensor_preCompute =>
        // checking the pre-state values of tempSensor's compute entrypoint is not required
        return T
      case tc.runtimemonitor.CaptureKind.tempSensor_postCompute =>
      ...
      case tc.runtimemonitor.CaptureKind.tempControl_postInit =>
        ...
        return result
      case tc.runtimemonitor.CaptureKind.tempControl_preCompute =>
        ...
        return result
      case tc.runtimemonitor.CaptureKind.tempControl_postCompute =>
      ...
      case tc.runtimemonitor.CaptureKind.operatorInterface_postInit =>
        ...
        return result
      case tc.runtimemonitor.CaptureKind.operatorInterface_preCompute =>
        ...
        return result
      case tc.runtimemonitor.CaptureKind.operatorInterface_postCompute =>
