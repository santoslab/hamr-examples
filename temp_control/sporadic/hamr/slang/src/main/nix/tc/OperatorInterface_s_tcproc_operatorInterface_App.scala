...
object OperatorInterface_s_tcproc_operatorInterface_App extends App {

  val entryPoints: Bridge.EntryPoints = Arch.TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface.entryPoints
  val appPortId: Art.PortId = IPCPorts.OperatorInterface_s_tcproc_operatorInterface_App
  val appPortIdOpt: Option[Art.PortId] = Some(appPortId)

  // incoming ports
  val currentTempPortId: Art.PortId = Arch.TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface.currentTemp.id
  val currentTempPortIdOpt: Option[Art.PortId] = Some(currentTempPortId)
  val tempChangedPortId: Art.PortId = Arch.TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface.tempChanged.id
  ...
  def compute(): Unit = {

    {
      ...
      out.value2 match {
        case Some(v: TempSensor.Temperature_i_Payload) => ArtNix.updateData(currentTempPortId, v)
    ...
    }
    {
      ...
      out.value2 match {
        case Some(v: art.Empty) => ArtNix.updateData(tempChangedPortId, v)
  ...
  def main(args: ISZ[String]): Z = {
    ...
    println("OperatorInterface_s_tcproc_operatorInterface_App starting ...")
