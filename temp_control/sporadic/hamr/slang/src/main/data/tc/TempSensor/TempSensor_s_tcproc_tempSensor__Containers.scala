...
@sig trait TempSensor_s_tcproc_tempSensor_PreState_Container extends art.DataContent {
}
...
@sig trait TempSensor_s_tcproc_tempSensor_PostState_Container extends art.DataContent {
