...
//   MS[Z,Option[art.Bridge]]=4 - Needed for Art.bridges
...
//   IS[Z,art.UPort]=3 - Needed for tempControl's dataIns ports
//   MS[Z,art.UPort]=3 - Needed for the ops.ISZOps(sorted).tail call used by ArtNativeSlang
//   IS[Z,(Z,art.ArtSlangMessage)]=17 - Needed for the backing store of Map[Z, ArgSlangMessage] in ArtNativeSlang
//   IS[Z,art.Art.BridgeId]=4 - Needed for Schedulers.roundRobinSchedule
//   IS[Z,art.scheduling.static.Schedule.Slot]=4 - Needed for Schedulers.staticSchedule
//   IS[Z,(String,art.Art.BridgeId)]=4 - Needed for the backing store of Scheduler.threadNickNames
  ...
  case Some(o: Cli.TranspileOption) =>
    if(o.legacy) {
      ...
      val main: ISZ[String] = ISZ(
        ...
        "--name", "main",
        "--apps", "tc.TempSensor_s_tcproc_tempSensor_App,tc.Fan_s_tcproc_fan_App,tc.TempControl_s_tcproc_tempControl_App,tc.OperatorInterface_s_tcproc_operatorInterface_App,tc.LegacyDemo",
        "--fingerprint", "3",
        "--bits", "32",
        "--string-size", "256",
        "--sequence-size", "1",
        "--sequence", s"MS[Z,Option[art.Bridge]]=4;IS[Z,String]=3;IS[Z,art.Art.PortId]=3;IS[Z,art.UPort]=3",
        "--constants", s"art.Art.numComponents=4;art.Art.numPorts=17;art.Art.numConnections=7",
      ...
      val main: ISZ[String] = ISZ(
        ...
        "--string-size", "256",
        "--sequence-size", "1",
        "--sequence", s"MS[Z,Option[art.Bridge]]=4;IS[Z,String]=3;IS[Z,art.Art.PortId]=3;IS[Z,art.UPort]=3;MS[Z,art.UPort]=3;IS[Z,(Z,art.ArtSlangMessage)]=17;IS[Z,art.Art.BridgeId]=4;IS[Z,art.scheduling.static.Schedule.Slot]=4;IS[Z,(String,art.Art.BridgeId)]=4",
        "--constants", s"art.Art.numComponents=4;art.Art.numPorts=17;art.Art.numConnections=7",
