...
case "${SCHEDULER}" in
  legacy)
    ...
    launch "TempSensor_s_tcproc_tempSensor_App${EXT} Fan_s_tcproc_fan_App${EXT} TempControl_s_tcproc_tempControl_App${EXT} OperatorInterface_s_tcproc_operatorInterface_App${EXT}";
