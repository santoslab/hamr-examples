  ...
  def post_initialise(): Unit = {
    ...
    val postStateContainer_wL =
      TempControl_s_tcproc_tempControl_PostState_Container_PS(
        ...
        fanError = tc.TempControlSoftwareSystem.TempControl_s_tcproc_tempControl.fanError,
  ...
  def pre_compute(dispatchedEventPortId: Art.PortId): Unit = {
    ...
    preStateContainer_wL = Some(
      TempControl_s_tcproc_tempControl_PreState_Container_PS(
        ...
        In_fanError = tc.TempControlSoftwareSystem.TempControl_s_tcproc_tempControl.fanError, 
